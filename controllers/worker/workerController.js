...
exports.getOpenComplaints = async (req, res) => {
  try {
...
exports.acceptComplaint = async (req, res) => {
  try {
    ...
    complaint.assignedWorker = req.user.name;

    complaint.workerAccepted = true;

    complaint.completionDeadline = new Date(Date.now() + 24 * 60 * 60 * 1000);
    ...
    // NOTIFICATION
    // ======================
    console.log(complaint.studentId);
    ...
    await Notification.create({
      ...
      message: `${req.user.name} accepted your complaint`,
